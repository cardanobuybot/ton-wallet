// Официальный Gram circular badge с ton.org/media (June 2026 rebrand).
// Инлайн-SVG, чтобы не тянуть внешний файл и не грузить сеть.
// Brand color: #30A1F5 (белая звезда/бриллиант на синем фоне).
export function GramLogo(props: { size?: number; className?: string }) {
